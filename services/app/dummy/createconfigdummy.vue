              ...
              <div class="w-[1036px] flex flex-col items-start justify-start pt-0 px-0 pb-4 gap-8">
                <div class="w-[1010px] flex flex-col items-start justify-start gap-1">
                  ...
                  <div class="w-full flex flex-col items-start justify-start gap-10 text-gray-200 mq450:gap-5">
                    ...
                    <div
                      class="w-[680px] flex flex-row flex-wrap md:gap-12 text-lg text-gray-400 mq450:gap-7">
                ...
                <div class="flex flex-col md:flex-row flex-wrap items-start justify-start gap-7">
                ...
                <div class="flex flex-col md:flex-col md:items-center md:justify-center w-full mt-[-20px] mq700:flex-wrap">
                  <button @click="addQA"
