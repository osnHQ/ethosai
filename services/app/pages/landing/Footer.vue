<template>
    ...
    <div class="flex flex-col items-start mb-8 mt-3 md:mb-0">
      <div class="mb-4 footer-logo w-30">
        <a href="https://ethosai.one/"><NuxtImg src="public/logo.png" alt="OpenQA.AI Logo" /></a>
      </div>
        ...
        <div class="flex flex-wrap justify-between w-full md:w-auto gap-x-40 gap-y-5 mr-20 mt-5">
          ...
          <li><a href="#" class="block mb-2 hover:text-gray-300">Releases</a></li> -->
            ...
            <div class="w-full md:w-auto mb-8 md:mb-0">
                ...
                <ul>
                    <li><a target="_blank" href="https://discord.gg/ENQMUjs5mU" class="block mb-2 hover:text-gray-300">Discord</a></li>
