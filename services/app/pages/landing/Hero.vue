    ...
    <div class="lg:h-[80vh] sm:h-auto container mx-auto lg:flex lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="max-md-w-full sm:w-full lg:w-1/2">
            ...
            <div class="max-md-text-center sm:text-center lg:text-left pt-12 pb-12 max-w-4xl font-bold max-md-text-4xl md:text-3xl lg:text-4xl">
                Creating safe AI future with our Decentralized LLM Auditing Infrastructure
            </div>
            ...
            <div class="flex lg:justify-start max-md-justify-center sm:justify-center">
                <a href="https://ethos-ai.gitbook.io/ethosai-whitepaper" class="flex justify-center my-8 lg:mr-5">
                    <button
                        class="bg-transparent hover:bg-gray-100 mr-4 px-6 py-3 border border-light rounded font-bold text-gray-800 text-light hover:text-dark">
                        Whitepaper
                    </button>
                </a>
                <a href="https://tally.so/r/nGrMK2" class="flex justify-center my-8">
                    <button
