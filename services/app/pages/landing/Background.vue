<template>
  ...
  <img src="/Stars.png" class="absolute w-200 left-80 md-hidden lg-block max-sm:hidden -z-1" alt="" />
  <img src="/Stars.png" class="absolute w-350 top-150 md-hidden lg-block max-sm:hidden -z-1" alt="" />
  <img src="/Stars.png" class="absolute w-350 top-460 md-hidden lg-block max-sm:hidden -z-1" alt="" />
</template>
