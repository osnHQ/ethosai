<template>
    <div class="w-350 relative shadow bg-white flex items-start justify-end text-left text-base text-dimgray font-inter">
      <main class=" flex-1 flex flex-col items-start justify-start pt-6 px-0 pb-0 md:max-w-280">
  ...
  <div class="flex flex-col px-7 py-7 bg-white rounded shadow-sm max-md:px-5">
    ...
    <div class="flex flex-col md:flex-row gap-5 self-start mt-5 text-sm leading-5 max-md:flex-wrap">
      <div class="flex flex-1 flex-auto gap-5">
        ...
        <NuxtImg loading="lazy" src="/downarrow.png" alt="" class=" w-5 h-5 " />
        </div>
      </div>
      <div
    ...
    <table class="mt-6 w-full text-sm leading-5 rounded border border-gray-100 border-solid bg-black bg-opacity-0">
      ...
      <tbody>
        <tr class="bg-white">
          ...
          <td class="px-4 py-10">
            <div class="flex gap-2">
              <NuxtImg loading="lazy" src="/avatar.png" alt="" class="w-9 aspect-square" />
        ...
        <tr class="bg-white">
          ...
          <td class="px-4 py-10">
            <div class="flex gap-2">
              <NuxtImg loading="lazy" src="/avatar2.png" alt="" class="w-9 aspect-square" />
        ...
        <!-- Repeat similar structure for other rows --><tr class="bg-white">
          ...
          <td class="px-4 py-10">
            <div class="flex gap-2">
              <NuxtImg loading="lazy" src="/avatar3.png" alt="" class="w-9 aspect-square" />
        ...
        <!-- Repeat similar structure for other rows --><tr class="bg-white">
          ...
          <td class="px-4 py-10">
            <div class="flex gap-2">
              <NuxtImg loading="lazy" src="/avatar4.png" alt="" class="w-9 aspect-square" />
              <span class="my-auto">Username</span>
            </div>
          </td>
          <td class="px-4 py-12">Audited</td>
    ...
    <nav class="flex gap-1 self-center mt-14 max-w-full text-sm leading-5 whitespace-nowrap text-zinc-400 w-[344px] max-md:mt-10" aria-label="Pagination">
      ...
      <span class="flex gap-1">
        <NuxtImg loading="lazy" src="/paginationdots.png" alt="" class="w-5 h-5 mt-3.5 aspect-square border-zinc-200" />
        <a href="#" class="justify-center items-start px-4 py-3.5 bg-white rounded border border-solid border-zinc-200">
          10
        </a>
        <a href="#" class="justify-center items-start px-4 py-3.5 bg-white rounded border border-solid border-zinc-200">
